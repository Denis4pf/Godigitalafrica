...
var contactString = "<div class='social'> <a target='_blank' href='tel:+254716124725'> <div class='socialItem' id='call'><img class='socialItemI' src='../images1/phone.svg'/><label class='number'></label></label></div> </a> <a href='mailto:godigitalafrica22@gmail.com'> <div class='socialItem'><img class='socialItemI' src='../images1/gmail.svg' alt=''></div> </a> <a target='_blank' href='https://www.facebook.com/godigitalafrica1/'> <div class='socialItem'><img class='socialItemI' src='../images1/facebook.svg' alt=''></div> </a> <a target='_blank' href='https://wa.me/000000000000'> <div class='socialItem'><img class='socialItemI' src='../images1/whatsapp.svg' alt=''></div><a target='_blank' href='https://www.instagram.com/godigitalafrica1/'> <div class='socialItem'><img class='socialItemI' src='../images1/instagram.svg' alt=''></div><a target='_blank' href='https://www.linkedin.com/company/#/'> <div class='socialItem'><img class='socialItemI' src='../images1/linkedin.svg' alt=''></div>";
...
function waitAndResponce(inputText) {
    ...
    if (inputText.toLowerCase().includes("my name is")) {
        ...
        if (name.toLowerCase().includes("Go Digital Africa")) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>We are<span class='bold'><a class='alink'> Go Digital Africa</a>.</span><br><br>Welcome to Go Digital Africa Solutions, Where Success in the Digital World Begins.<br><br>Send <span class='bold'style='color:yellow;'>'Help'</span> to know more about our company or <br>Send <span class='bold' style='color:yellow;'>'Website'</span> to go back to the website <br><br><span style='font-size:10px;'>Note : Scroll Down To aceess The textbox.</span>");
            }, 2000);
            break;
        ...
        case "graphic design":
            sendTextMessage("<span style='color:yellow;font-weight:bold;'>Graphic Design</span><br><br>At Go Digital Africa, your destination for exceptional graphic design services. We are a team of passionate designers dedicated to transforming your ideas into captivating visual experiences. With our expertise in graphic design, we bring your brand to life through stunning visuals that leave a lasting impression.");
            break;

        case "website design":
            sendTextMessage("<span style='color:yellow;font-weight:bold;'>Website Design</span><br><br>At Go Digital Africa, we understand the significance of a well-designed website in today's digital landscape. We take a collaborative approach, working closely with you to understand your goals, target audience, and unique brand identity.");
            break;
        ...
        case "projects":
            sendTextMessage("You want to check my projects? Then just jump into my Github Account.<br><br><div class='social'><a target='_blank' href='https://github.com/Denis4pf'> <div class='socialItem'><img class='socialItemI' src='../images1/github.svg' alt=''></div> </a></div>");
            break;
        case "time":
            var date = new Date();
        ...
        case "website":
            sendTextMessage("Click to go to the website here <a href='../index.html' style='color:yellow;font-weight:500'>Go Digital Africa</a>");
            break;
        // case "blog":
        //     sendTextMessage("You can check my blog here <a target='_blank' href='https://varshithvhegde.github.io/hugo-blog'>Go Digital Africa</a>");
        //     break;

        // case "github":
        //     sendTextMessage("You can check my github here <a target='_blank' href='https://github.com/Varshithvhegde'>Go Digital Africa</a>");
        //     break;
        // case "linkedin":
        //     sendTextMessage("You can check my linkedin here <a target='_blank' href='https://www.linkedin.com/in/varshithvhegde'>Go Digital Africa</a>");
        //     break;
        // case "friends":
        // case "friend":
